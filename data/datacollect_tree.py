# in this script the method of 4 binary tree will be used to seperate the erea into blocks
import numpy as np
...
# ----- data direction  -----
# --------------------------------------
output_folder = '/media/rubing/hdd/data_label/IKG_hdf5_train_tree1'
if not os.path.exists(output_folder):
    os.mkdir(output_folder)
path_label = '/media/rubing/hdd/labels/20170331/label/'  # 20170405 for test ,20170331 for train
